...
// Variables ----------------------------------------------------------------------------
const tooltipClasses = ['tooltip-dl', 'tooltip-d', 'tooltip-dr', 'tooltip-u', 'tooltip-ul'];
    ...
    tooltips.forEach(tooltip => {
        ...
        tooltip.addEventListener('mouseenter', () => {
            ...
            if (fastTransitionMode)
                ...
                hoveringTimer = setTimeout(onTooltipVisible, tooltipDelayMillis);
        });
