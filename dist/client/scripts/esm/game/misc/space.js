...
function convertCoordToWorldSpace(coords, position = boardpos.getBoardPos(), scale = boardpos.getBoardScale()) {
    const squareCenter = board.gsquareCenter();
    return [
...
function convertCoordToWorldSpace_IgnoreSquareCenter(coords, position = boardpos.getBoardPos(), scale = boardpos.getBoardScale()) {
    return [
 ...
 */
function getVisualCenterOfSquare(coords) {
    const squareCenter = board.gsquareCenter();
    return [
