...
function trimTokensToSessionCap(refreshTokens) {
    ...
    if (refreshTokens.length <= sessionCap)
...
export { deleteRefreshTokenFromTokenList, addTokenToRefreshTokens, removeExpiredTokens, getTimeMillisSinceIssued, trimTokensToSessionCap, };
