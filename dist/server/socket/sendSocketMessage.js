 ...
 */
function sendSocketMessage(ws, sub, action, value, replyto, { skipLatency } = {}) {
 ...
 */
function sendNotify(ws, translationCode, { replyto, customNumber } = {}) {
...
function rescheduleRenewConnection(ws) {
    ...
    if (Object.keys(ws.metadata.subscriptions).length === 0)
