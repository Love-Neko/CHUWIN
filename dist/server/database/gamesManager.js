 ...
 */
function addGameToGamesTable(options) {
 ...
 */
function isGameIdTaken(game_id) {
    try {
 ...
 */
function getGameData(game_id, columns) {
    ...
    try {
        ...
        const row = db.get(query, [game_id]);
...
function updateGameColumns(game_id, columnsAndValues) {
...
// Exports --------------------------------------------------------------------------------------------
export { addGameToGamesTable, getGameData,
