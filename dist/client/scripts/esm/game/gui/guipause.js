...
const element_aicoach = document.getElementById('aicoach');
...
/**
 * Opens the AI Coach panel. The pause menu closes first — the panel is a side
 * panel that leaves the board playable, so staying paused would defeat the point.
 */
