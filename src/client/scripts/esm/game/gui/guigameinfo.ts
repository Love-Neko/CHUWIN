 ...
 */
function getResultText(conclusion: string): string {
	...
	const drawMoveRule = (): string => `${resultTranslations.draw_moverule[0]}${(gamefile.gameRules.moveRule! / 2)}${resultTranslations.draw_moverule[1]}`;

	if (onlinegame.areInOnlineGame()) {

		if (victor !== undefined && onlinegame.getOurColor() === victor) return condition === 'checkmate' ? resultTranslations.you_checkmate
		...
		else if (victor === players.NEUTRAL) return condition === 'stalemate' ? resultTranslations.draw_stalemate
		...
		else if (condition === 'aborted') return resultTranslations.aborted;
		else /* loss */ return condition === 'checkmate' ? resultTranslations.opponent_checkmate
	...
	if (condition === 'checkmate') return victor === players.WHITE ? resultTranslations.white_checkmate
                                                                    : victor === players.BLACK ? resultTranslations.black_checkmate
                                                                    : resultTranslations.bug_checkmate;
	else if (condition === 'time') return victor === players.WHITE ? resultTranslations.white_time
                                                                    : victor === players.BLACK ? resultTranslations.black_time
                                                                    : resultTranslations.bug_time;
	else if (condition === 'royalcapture') return victor === players.WHITE ? resultTranslations.white_royalcapture
                                                                            : victor === players.BLACK ? resultTranslations.black_royalcapture
                                                                            : resultTranslations.bug_royalcapture;
	else if (condition === 'allroyalscaptured') return victor === players.WHITE ? resultTranslations.white_allroyalscaptured
                                                                                : victor === players.BLACK ? resultTranslations.black_allroyalscaptured
                                                                                : resultTranslations.bug_allroyalscaptured;
	else if (condition === 'allpiecescaptured') return victor === players.WHITE ? resultTranslations.white_allpiecescaptured
                                                                                : victor === players.BLACK ? resultTranslations.black_allpiecescaptured
                                                                                : resultTranslations.bug_allpiecescaptured;
	else if (condition === 'threecheck') return victor === players.WHITE ? resultTranslations.white_threecheck
                                                                            : victor === players.BLACK ? resultTranslations.black_threecheck
                                                                            : resultTranslations.bug_threecheck;
	else if (condition === 'koth') return victor === players.WHITE ? resultTranslations.white_koth
                                                                    : victor === players.BLACK ? resultTranslations.black_koth
                                                                    : resultTranslations.bug_koth;
	else if (condition === 'stalemate') return resultTranslations.draw_stalemate;
	else if (condition === 'repetition') return resultTranslations.draw_repetition;
	else if (condition === 'moverule') return drawMoveRule();
	else if (condition === 'insuffmat') return resultTranslations.draw_insuffmat;
