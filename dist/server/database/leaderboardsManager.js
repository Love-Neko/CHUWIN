 ...
 */
function addUserToLeaderboard(user_id, leaderboard_id) {
 ...
 * @returns A result object indicating success or failure.
 */
function updatePlayerLeaderboardRating(user_id, leaderboard_id, elo, rd) {
 ...
 */
function isPlayerInLeaderboard(user_id, leaderboard_id) {
 ...
 */
function getPlayerLeaderboardRating(user_id, leaderboard_id) {
    ...
    try {
        ...
        // Added leaderboard_id to parameters
        const row = db.get(query, [user_id, leaderboard_id]);
 ...
 */
function getAllUserLeaderboardEntries(user_id) {
    ...
    `;
    try {
        const entries = db.all(query, [user_id]);
        return entries;
    }
    catch (error) {
        const message = error instanceof Error ? error.message : String(error);
 ...
 */
function getTopPlayersForLeaderboard(leaderboard_id, n_players) {
    ...
    try {
        ...
        // Added leaderboard_id to parameters
        const top_players = db.all(query, [leaderboard_id, n_players]);
 ...
 */
function getPlayerRankInLeaderboard(user_id, leaderboard_id) {
    ...
    try {
        ...
        const result = db.get(query, [leaderboard_id, user_id]);
 ...
 */
function getDisplayEloOfPlayerInLeaderboard(user_id, leaderboard_id) {
 ...
 */
function getLeaderboardOfVariant(variant) {
    return VariantLeaderboards[variant];
}
// Exports --------------------------------------------------------------------------------------------
// Updated export names to be more descriptive
export { Leaderboards, VariantLeaderboards, addUserToLeaderboard, updatePlayerLeaderboardRating, isPlayerInLeaderboard, getPlayerLeaderboardRating, getAllUserLeaderboardEntries, // Added export for the new function
getTopPlayersForLeaderboard, getPlayerRankInLeaderboard, getDisplayEloOfPlayerInLeaderboard };
