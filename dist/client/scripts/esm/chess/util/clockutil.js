...
function splitTimeControl(time_control) {
    ...
    if (time_control === '-')
        return { base_time_seconds: null, increment_seconds: null };
    ...
    if (isNaN(base_time_seconds) || isNaN(increment_seconds) || base_time_seconds <= 0 || increment_seconds < 0)
