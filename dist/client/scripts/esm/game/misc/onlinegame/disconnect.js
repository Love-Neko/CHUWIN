...
function displayOpponentDisconnect(secsRemaining, wasByChoice) {
    ...
    if (!afk.isOurAFKAutoResignTimerRunning())
        statustext.showStatusForDuration(`${opponent_disconnectedOrLostConnection} ${resigningOrAborting} ${secsRemaining}...`, 1000);
