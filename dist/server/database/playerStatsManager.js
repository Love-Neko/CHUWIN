 ...
 */
function addUserToPlayerStatsTable(user_id) {
    const query = `
 ...
 */
function getPlayerStatsData(user_id, columns) {
 ...
 * @returns - A result object indicating success or failure.
 */
function updatePlayerStatsColumns(user_id, columnsAndValues) {
...
// Exports --------------------------------------------------------------------------------------------
export { addUserToPlayerStatsTable, getPlayerStatsData, updatePlayerStatsColumns };
